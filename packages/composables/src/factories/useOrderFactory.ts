...
export function useOrderFactory <ORDER>(factoryParams: UseOrderFactoryParams<ORDER>): useOrder<ORDER> {
  ...
  return function useOrder () {
    ...
    /* @readonly */
    const response: Ref<ORDER | null> = sharedRef(null, 'useOrder-response');
