...
import { ordersHistoryGetters, useOrdersHistory } from '@vue-storefront/orc-vsf';
...
export default {
  ...
  setup() {
    const { response: orders, load } = useOrdersHistory();
    const ordersHistory = computed(() => ordersHistoryGetters.getOrdersHistory(orders.value));
