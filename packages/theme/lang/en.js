...
export default {
  ...
  'Order No.': 'Order No.',
  'Successful placed order': 'You have successfully placed the order. Your order confirmation and receipt will be sent to {email}. If you did not receive the email, check your spam folder.',
